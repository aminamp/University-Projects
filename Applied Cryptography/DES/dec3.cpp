...
void decrypt3(char *key, char *tablefilename, char *filename)
{
    ...
    if( !filename )
    {
        ...
        tempFile.close();
        decrypt3( key, tablefilename, tempFileName);
        remove(tempFileName);
        ...
        if( inputFile == NULL )
        {
            ...
            while(1)
            {
                ...
                if ( counter <= 0 )
                    ...
                    decryptfunction(inputbuffer, keys3, S, P, IP, invIP, E, result, end);
                    encryptfunction(result, keys2, S, P, IP, invIP, E, result, end, 1);
                    decryptfunction(result, keys1, S, P, IP, invIP, E, result, end);
